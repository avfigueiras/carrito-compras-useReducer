                ...
                {isEmptyCart ? (
                  ...
                  <>
                      ...
                      <tbody>
                        {cart.map((guitar) => (
                          <tr key={guitar.id}>
                            ...
                            <td>
                              <button className="btn btn-danger" type="button" onClick={() => dispatch({type:'delete-from-cart', payload: {id: guitar.id}})}>
                                X
                              </button>
                            </td>
                          </tr>
                    ...
                    <p className="text-end">
                      Total pagar: <span className="fw-bold">${totals}</span>
                    </p>
                  </>
                )}
                <button className="btn btn-dark w-100 mt-3 p-2" onClick={() => dispatch({type:'clean-cart'})}>
                  Vaciar Carrito
                </button>
              </div>
            </div>
